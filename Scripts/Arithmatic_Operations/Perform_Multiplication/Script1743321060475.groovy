...
Mobile.startApplication('D:\\coding\\sqa\\espresso\\App-Automation-on-Google-Calculator-with-Selenium-Appium\\src\\test\\resources\\Calculator.apk', 
    true)

// Perform 3 + 2
Mobile.tap(findTestObject('digit_3'), 0)

Mobile.tap(findTestObject('multiply_button'), 0)
